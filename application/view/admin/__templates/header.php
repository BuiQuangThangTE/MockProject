...
<div class="wrapper">
    ...
    <header class="main-header">
        <!-- Logo -->
        <a href="<?php echo URL ?>admin/index_view" class="logo">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="<?php echo URL ?>dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="<?php echo URL ?>dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
                            ...
                            <li class="user-footer">
                                <form action="<?php echo URL?>/admin/logout" method="post">
                                    ...
                                    <div class="pull-right">
                                        <input type="submit" class="btn btn-default btn-flat" name="logout-ad" value="Logout">
                                    </div>
                                </form>
                            </li>
                        </ul>
